...
function NotificationBadge({ count, sizeKey, type }) {
  ...
  return (
    <div
      className="dc:absolute dc:flex dc:items-center dc:justify-center dc:bg-purple"
      style={{
        left, top,
...
function VerifyBadge({ sizeKey }) {
  ...
  return (
    <div className="dc:absolute" style={{ bottom: '75%', left: '75%', right: '-8.33%', top: '-8.33%' }}>
...
function DenyBadge({ sizeKey }) {
  ...
  return (
    <div className="dc:absolute" style={{ left: isSmall ? '12px' : '18px', top: isSmall ? '-1.33px' : '-2px', width: `${dim}px`, height: `${dim}px` }}>
      <svg width={dim} height={dim} viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg"
        className="dc:absolute dc:inset-0 dc:w-full dc:h-full">
...
export function Section({
  ...
  return (
    <div
      ...
      className={`dc:relative dc:flex dc:items-center dc:justify-center dc:shrink-0 dc:select-none ${isInteractive ? 'dc:cursor-pointer' : ''}`}
      style={{
        width: `${w}px`,
        height: `${h}px`,
        borderRadius: `${r}px`,
    ...
    >
      ...
      {isSelected && (
        <div
          className="dc:absolute dc:bg-purple"
          style={{
